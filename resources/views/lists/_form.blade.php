<div class="sub_section">
    ...
    <div class="col-md-12 create-div-top">
        <h3 class="text-semibold">{{ trans('messages.list_details') }}</h3>
        <div class="row">
            <div class="col-md-6">
        ...
        <!-- the following are settings for users' own sending servers, not system ones, so disabled in NON-SAAS mode -->
                            ...
                            <div class="row mb-5 form-groups-bottom-0">
                                ...
                                <div class="col-md-3" show-with-control="input[name='{{ 'sending_servers[' . $server->uid . '][check]' }}']">
                                    @include('helpers.form_control', [
                                        ...
                                        'label' => '',
                                        'value' => ($list->mailListsSendingServers()->where('sending_server_id', $server->id)->first() ? $list->mailListsSendingServers()->where('sending_server_id', $server->id)->first()->fitness : "100"),
                                        'help_class' => 'list',
                                        'rules' => Acelle\Model\MailList::$rules
                                    ])
                                </div>
