<h3 class="mt-5 mb-3"><span class="material-symbols-rounded me-2">drafts</span> {{ trans('messages.top_country_by_opens') }}</h3>
<div class="row">
    <div class="col-md-6">
    ...
    <div class="col-md-6">
        @if ($campaign->uniqueOpenCount())
                ...
                <div class="">
                    <div class="chart-container has-scroll">
                        <div class="chart has-fixed-height"
                            ...
                            data-url="{{ action('Pub\CampaignController@chartCountry', $campaign->uid) }}">
                        </div>
                    </div>
                </div>
            </div>
            ...
            <script>
                ...
                var OpenPieChart = {
                    url: '{{ action('Pub\CampaignController@chartCountry', $campaign->uid) }}',
                    getChart: function() {
                        return $('#OpenPieChart');
                    },
