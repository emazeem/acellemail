...
@section('content')
	...
	<h2 class="text-bold text-primary mb-10"><span class="material-symbols-rounded">splitscreen</span> {{ $segment->name }}</h2>
	<h3><span class="material-symbols-rounded">people</span> {{ trans('messages.subscribers') }}</h3>
