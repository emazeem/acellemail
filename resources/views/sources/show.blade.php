        ...
        <div class="col-md-8">
                ...
                <div class="source-desc">
                    ...
                    <div class="text-muted">
                        {{ trans('messages.source.connected_on', [
                            'date' => Auth::user()->customer->formatDateTime($source->created_at, 'datetime_full'),
                        ]) }}
                        |
            ...
            <div class="d-flex my-4 py-4 align-items-center">
                <div class="mr-auto pr-4" style="width: 500px">
                    <h4 class="font-weight-semibold mb-1">{{ trans('messages.store.connected') }}</h4>
            ...
            <div class="source-stats">
                ...
                <div class="source-desc-line pt-4 my-4 d-flex" style="justify-content: space-between">
                    <div class="d-flex">
                        <div class="mr-4">
                            <span class="material-symbols-rounded" style="font-size:24px">fact_check</span>
                        </div>
                        <div class="desc">
                ...
                @if ($automation->getAbandonedCartEmail()->isSetup())
                    <div class="source-desc-line pt-4 my-4 d-flex">
                        <div class="mr-4">
                            <span class="material-symbols-rounded" style="font-size:24px">mark_email_unread</span>
                        </div>
                        <div class="desc">
