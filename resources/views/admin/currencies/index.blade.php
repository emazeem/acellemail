...
@section('page_header')
			...
			<div class="page-title">
				...
				<h1>
					<span class="text-semibold"><span class="material-symbols-rounded">format_list_bulleted</span> {{ trans('messages.currencies') }}</span>
				</h1>
			</div>
								...
								<div class="filter-box">
									...
									<div class="btn-group list_actions me-2" style="display:none">
										...
										<ul class="dropdown-menu">
											<li><a class="dropdown-item" link-confirm="{{ trans('messages.enable_currencies_confirm') }}" href="{{ action('Admin\CurrencyController@enable') }}"><span class="material-symbols-rounded">play_arrow</span> {{ trans('messages.enable') }}</a></li>
											<li><a class="dropdown-item" link-confirm="{{ trans('messages.disable_currencies_confirm') }}" href="{{ action('Admin\CurrencyController@disable') }}"><span class="material-symbols-rounded">hide_source</span> {{ trans('messages.disable') }}</a></li>
											<li>
