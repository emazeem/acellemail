...
@section('page_header')
    ...
    <div class="page-title">
        ...
        <h1>
            <span class="text-semibold"><span class="material-symbols-rounded">format_list_bulleted</span> {{ trans('messages.customers') }}</span>
        </h1>
    </div>
    ...
    <div class="listing-form"
        ...
        <div class="d-flex top-list-controls top-sticky-content">
            ...
            @can('create', new Acelle\Model\Customer())
                <div class="text-end">
                    <a href="{{ action("Admin\CustomerController@create") }}" role="button" class="btn btn-primary">
