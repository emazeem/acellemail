    ...
    <div class="row">
        <div class="col-md-10">
        	<div class="page-title">
	            ...
	            <h1>
	                <span class="text-semibold"><span class="material-symbols-rounded">format_list_bulleted</span> {{ trans('messages.bounce_handlers') }}</span>
	            </h1>
                    ...
                    <div class="filter-box">
                        ...
                        <div class="dropdown list_actions" style="display: none">
                            ...
                            <ul class="dropdown-menu">
                                <li><a class="dropdown-item" link-confirm="{{ trans('messages.delete_bounce_handlers_confirm') }}" href="{{ action('Admin\BounceHandlerController@delete') }}"><span class="material-symbols-rounded">delete_outline</span> {{ trans('messages.delete') }}</a></li>
                            </ul>
                        </div>
