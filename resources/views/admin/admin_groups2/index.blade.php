...
@section('page_header')
    ...
    <div class="page-title">
        ...
        <h1>
            <span class="text-semibold"><span class="material-symbols-rounded">format_list_bulleted</span> {{ trans('messages.user_groups') }}</span>
        </h1>
    </div>
...
<button type="button" class="btn btn-light sort-direction" data-popup="tooltip" title="{{ trans('messages.change_sort_direction') }}" role="button" class="btn btn-xs">
            ...
            @can('create', new Acelle\Model\AdminGroup())
                <div class="text-end">
                    <a href="{{ action("Admin\AdminGroup2Controller@create") }}" role="button" class="btn btn-primary">
