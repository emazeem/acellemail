    ...
    var TemplateBuilderEdit = {
        ChatUI: class {
            ...
            loadFrame() {
                ...
                this.chatFrame = $(`<iframe src="{{ action('Admin\TemplateController@chat') }}" style="border:none;
            ...
            loadChatButton() {
                this.chatButton = $(`
                    <div class="dropdown chat-dropdown" style="display:none">
                        <button class="btn btn-primary px-2" type="button" id="dropdownChatButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"
