        ...
        <div class="text-end">
            <div class="dropdown d-inline-block">
                ...
                <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                  ...
                  <li><a class="dropdown-item active" href="javascript:;">{{ trans('messages.plan.style_1') }}</a></li>
            ...
            <a target="_blank" href="{{ action("PlanController@publicListPage", ['style' => 'style1']) }}" role="button" class="btn btn-primary modal-action">
