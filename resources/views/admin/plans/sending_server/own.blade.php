        ...
        <div class="mc-section">
            <div class="announce_box">
                <div class="row flex-center">
                    <div class="col-md-8">
                        <span class="material-symbols-rounded announce_box-icon">person_outline</span>
                ...
                <div class="row">
                    @foreach (Acelle\Model\SendingServer::types() as $key => $type)
                        <div class="col-md-4 pt-2 d-flex align-items-center">
                            ...
                            &nbsp;&nbsp;<span class="text-semibold text-italic">{{ trans('messages.sending_server.type.' . $key) }}</span>
