    ...
    <div class="row bg-white profile-bg" style="border-radius: 20px;">
        ...
        <form enctype="multipart/form-data" action="{{ action('AccountController@profile') }}" method="POST" class="form-validate-jqueryz">
                        ...
                        <div class="media profile-image">
                            <div class="media-left">
                                <a href="#" class="upload-media-container" onclick="$('input[name=image]').trigger('click')">
                                    <img preview-for="image" empty-src="{{ AppUrl::asset('images/placeholder.jpg') }}" src="{{ $user->getProfileImageUrl() }}" class="img-circle" alt="">
                                </a>
            ...
            <div class="text-start mb-3">
                <button class="btn btn-primary px-5"><i class="icon-check"></i> {{ trans('messages.save') }}</button>
            </div>
            <form>
    </div>
