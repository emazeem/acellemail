<h3 class="mt-5 mb-3"><span class="material-symbols-rounded me-2">ads_click</span> {{ trans('messages.top_country_by_clicks') }}</h3>
<div class="row">
    <div class="col-md-6">
        ...
        @else
            ...
            <div class="text-end">
                <a href="{{ action('CampaignController@clickLog', $campaign->uid) }}" class="btn btn-primary">{{ trans('messages.click_log') }} <span class="material-symbols-rounded">arrow_forward</span></a>
            </div>
        @endif
    </div>
    <div class="col-md-6">
