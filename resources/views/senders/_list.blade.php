	...
	>
		...
		@foreach ($senders as $key => $sender)
			<tr>
				...
				<td>
					<span class="no-margin kq_search">{{ Auth::user()->customer->formatDateTime($sender->created_at, 'datetime_full') }}</span>
